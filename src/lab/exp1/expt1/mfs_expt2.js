...
function initial_function(){
  var index=0;
        ...
        document.getElementById("demo").innerHTML = "Prepare a 4.1 × 10-6 M fluorescein solution in spectroscopy grade ethanol from a 8.2 × 10-4 M fluorescein stock solution. <br>Click on the volumetric flask containing the fluorescein solution to take it onto the instrument table.";        var modal = document.getElementById('manual');
